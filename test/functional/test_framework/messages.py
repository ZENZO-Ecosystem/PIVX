...
COIN = 100000000  # 1 ZEN in satoshis
...
# Objects that map to zenzod objects, which can be serialized/deserialized
class CAddress:
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in zenzod indicates these should be deserialized as blocks
